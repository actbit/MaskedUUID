...
public class MaskedUUIDNullableGuidConverterTests
{
    private readonly Mock<IMaskedUUIDService> _serviceMock;
    private readonly MaskedUUIDNullableGuidConverter _converter;
    private readonly Guid _testGuid = Guid.Parse("12345678-1234-5678-1234-567812345678");

    public MaskedUUIDNullableGuidConverterTests()
    {
        _serviceMock = new Mock<IMaskedUUIDService>();
        _converter = new MaskedUUIDNullableGuidConverter(_serviceMock.Object);
    }
    ...
    public void Read_WithValidMaskedUuid_ReturnsDecodedGuid()
    {
        ...
        var jsonBytes = Encoding.UTF8.GetBytes($"\"{maskedUuid}\"");
        ...
        Assert.Equal(_testGuid, result.Value);
